...
for i = 1:numel(y)
    for k = 1:K
        ...
        J = J + (1 / m) * ((-yi * log(a3(i,k)) - ((1 - yi) * log(1 - a3(i,k)))));
     end
end
...
% for t = 1:m
%     % Working with the t-th training example
%     a1 = X(t,:);
%     z2 = a1 * Theta1';
%     a2 = [1 sigmoid(z2)];
%     z3 = a2 * Theta2';
...
%     
%     accumulated_delta_1 = accumulated_delta_1 + (delta_2 * a1');
%     accumulated_delta_2 = accumulated_delta_2 + (delta_3 * a2');
%     
% end
